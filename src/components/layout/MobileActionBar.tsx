...
export function MobileActionBar() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 inset-x-0 z-40 p-3 pointer-events-none">
      <div className="max-w-md mx-auto glass-dark bg-[#0a0a10]/90 border border-white/[0.08] rounded-2xl p-2 flex items-center justify-between shadow-2xl shadow-black/80 pointer-events-auto">
        {/* Catalog shortcut */}
        <a
          href="#catalog"
          className="flex-1 py-2 px-2 rounded-xl flex flex-col items-center justify-center text-zinc-500 hover:text-white transition-colors active:scale-95"
        >
        ...
        <button
          ...
          className="flex-1 py-2 px-2 rounded-xl flex flex-col items-center justify-center text-zinc-500 hover:text-moya-green transition-colors active:scale-95"
        ...
        <button
          onClick={toggleCart}
          className="py-2.5 px-4 rounded-xl bg-moya-red hover:bg-rose-500 active:bg-moya-red-deep text-white font-display font-bold text-xs flex items-center gap-2 shadow-lg shadow-moya-red-deep/50 transition-transform active:scale-95 shrink-0"
        >
